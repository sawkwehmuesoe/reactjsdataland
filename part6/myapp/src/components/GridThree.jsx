...
//         <div>
//             <h4>Thanks for helping us {persons[0].name}. {persons[0].msg} ?</h4>
//             <h4>Thanks for helping us {persons[1].name}. {persons[1].msg} ?</h4>
//             <h4>Thanks for helping us {persons[2].name}. {persons[2].msg} ?</h4>
