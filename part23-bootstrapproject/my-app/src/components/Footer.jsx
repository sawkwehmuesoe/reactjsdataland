                ...
                <div className="container-fluid">
                    <div className="row text-light py-4">
                        ...
                        <div className="col-md-3 col-sm-6">
                            ...
                            <ul className="list-unstyled">
                                ...
                                <li><Link to="/customers" className="footerlinks">Customer</Link></li>
                        ...
                        <div className="col-md-3 col-sm-6">
                            ...
                            <ul className="list-unstyled">
                                <li><a href="#" className="footerlinks text-uppercase">Customer Service</a></li>
                                <li><a href="#" className="footerlinks text-uppercase">Online Chat</a></li>
                                <li><a href="#" className="footerlinks text-uppercase">Support</a></li>
                                <li><a href="#" className="footerlinks text-uppercase">info@plancco.com</a></li>
                            </ul>
                        </div>
                    ...
                    <div className="text-light border-top pt-4 d-flex justify-content-between">
                        ...
                        <ul className="list-unstyled d-flex">
                            <li ><a href="#" className="nav-link"><FontAwesomeIcon icon="fa-brands fa-x-twitter" /></a></li>
                            <li className="mx-3"><a href="#" className="nav-link"><FontAwesomeIcon icon="fa-brands fa-square-instagram" /></a></li>
                            <li><a href="#" className="nav-link"><FontAwesomeIcon icon="fa-brands fa-square-facebook" /></a></li>
                        </ul>
                    </div>
                </div>
            </footer>
