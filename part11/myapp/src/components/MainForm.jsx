            ...
            <form action="" method="" onSubmit={submitHandler}>
                ...
                <div className="row">
                    ...
                    <div className="form-group col-md-6 mb-3">
                        ...
                        <input type="text" name="name" id="name" className="form-control form-control-sm rounded-0" onChange={changeHandler} value={formState.name} placeholder="Enter Name" />
                    </div>
                    ...
                    <div className="form-group col-md-6 mb-3">
                        ...
                        <select name="package" id="package" className="form-select form-select-sm rounded-0" onChange={changeHandler} value={formState.package} >
                            <option value="" disabled>{defaultselectvalue}</option>
